        ...
        @includeif('partials.errors')
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Update') }} Reproductore</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('reproductores.update', $reproductore->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
