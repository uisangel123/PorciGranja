<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('id_Porcino_Macho', $machosDisponibles->pluck('id', 'id'), $reproduccione->id_Porcino_Macho, ['class' => 'form-control' . ($errors->has('id_Porcino_Macho') ? ' is-invalid' : ''), 'placeholder' => 'Id Porcino Macho', 'id' => 'macho']) }}{{--El name enviar el valor como null (revisar)--}}
            {!! $errors->first('id_Porcino_Macho', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('id_Porcino_Hembra') }}
            {{ Form::select('id_Porcino_Hembra', $hembrasDisponibles->pluck('id', 'id'), $reproduccione->id_Porcino_Hembra, ['class' => 'form-control' . ($errors->has('id_Porcino_Hembra') ? ' is-invalid' : ''), 'placeholder' => 'Id Porcino Hembra', 'id' => 'hembra']) }}
