<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('id_Porcino_Macho', $machosDisponibles->pluck('id', 'id'), $reproduccione->id_Porcino_Macho, ['class' => 'form-control' . ($errors->has('id_Porcino_Macho') ? ' is-invalid' : ''), 'placeholder' => 'Id Porcino Macho', 'id' => 'macho', 'name' => 'macho']) }}
